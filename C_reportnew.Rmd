...
ggplot()+
  ...
  ggview::canvas(h=9,w=15)
ggsave("NewFigures/DENSE_LINES_1024.pdf", width = 15, h=9)
...
ggplot()+
  ...
  ggview::canvas(h=9,w=15)
ggsave("NewFigures/DENSE_LINES_1024_noleg.pdf", width = 15, h=9)
```
...
ggplot()+
  ...
  theme(text = element_text(size=15), 
        ...
        legend.position = "bottom")+
  ggview::canvas(h=9,w=15)
ggsave("NewFigures/FUNG_LINES_1024.pdf", width = 15, h=9)
...
ggplot()+
  ...
  theme(text = element_text(size=15), 
        ...
        legend.position = "none")+
  ggview::canvas(h=9,w=15)
ggsave("NewFigures/FUNG_LINES_1024_noleg.pdf", width = 15, h=9)
```
