---
title: "Una seconda proposta per i grafici"
...
time1 <- ggplot(t1 %>% filter(dim<1024))+
  ...
  geom_boxplot(aes(x = b,
               ...
               outlier.shape = NA)+
  facet_grid(algo~dimf)+
  ylab(TeX("Ratio between computational times in seconds"))+
  xlab(TeX("u"))+
  scale_y_log10()+
  theme(text = element_text(size=15), 
        axis.text.x = element_text(angle = 00, hjust = 1))
...
L <- ggplot(t1)+
  ...
  geom_boxplot(aes(x = b,
               ...
               outlier.shape = NA)+
  facet_grid(algo~dimf)+
  ylab(TeX("Ratio of times in seconds"))+
  xlab(TeX("u"))+
  scale_y_log10()+
  theme(text = element_text(size=15), 
        axis.text.x = element_text(angle = 00, hjust = 1))
...
plotEP <- all_EP %>% as_tibble() %>% 
  ...
  geom_boxplot(aes(x = Var3, y = value))+
  xlab("") + ylab(TeX("Ratio of times in seconds"))+
    theme(text = element_text(size=15))#+coord_flip()
plotEP
plotEP+ggview::canvas(h=5,w=15)
